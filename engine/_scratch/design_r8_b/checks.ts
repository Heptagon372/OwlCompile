...
import { manhattan, parseMap, run, samePos } from './run';
import { score } from './score';
import { ROUND_EXTRAS } from './solutions';
import * as r8 from './rounds/r8';
import { check, eq, type Check } from './verify-util';
import { catCycle, reachableActions } from './verify-search';
// (붙여 넣은 뒤에는 위 import 줄을 지우고 verify-rounds.ts의 import에 manhattan·catCycle·r8만 더한다.)
